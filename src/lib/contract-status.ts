...
export const CONTRACT_STATUSES = {
  ...
  ACCOUNTING_FINAL: "ACCOUNTING_FINAL",
  COMPLETED: "COMPLETED",
  CANCELLED: "CANCELLED",
} as const;
...
export const contractStatusLabels: Record<ContractStatus, string> = {
  ...
  SHIPPING_LOGISTICS: "Giao vận & XNK",
  TAX_SETTLEMENT: "Quyết toán thuế",
  ACCOUNTING_FINAL: "Kế toán quyết toán",
...
export const contractStatusStyles: Record<ContractStatus, string> = {
  ...
  SHIPPING_LOGISTICS: "bg-cyan-50 text-cyan-700 border-cyan-200",
  TAX_SETTLEMENT: "bg-orange-50 text-orange-700 border-orange-200",
  ACCOUNTING_FINAL: "bg-rose-50 text-rose-700 border-rose-200",
...
const ALLOWED_TRANSITIONS: Record<ContractStatus, ContractStatus[]> = {
  ...
  [CONTRACT_STATUSES.ACTIVE]: [CONTRACT_STATUSES.SHIPPING_LOGISTICS, CONTRACT_STATUSES.CANCELLED],
  [CONTRACT_STATUSES.SHIPPING_LOGISTICS]: [CONTRACT_STATUSES.TAX_SETTLEMENT, CONTRACT_STATUSES.CANCELLED],
  [CONTRACT_STATUSES.TAX_SETTLEMENT]: [CONTRACT_STATUSES.ACCOUNTING_FINAL, CONTRACT_STATUSES.CANCELLED],
  [CONTRACT_STATUSES.ACCOUNTING_FINAL]: [CONTRACT_STATUSES.COMPLETED, CONTRACT_STATUSES.CANCELLED],
...
const ROLE_PERMISSIONS: Record<ContractRole, ContractAction[]> = {
  ADMIN: [
    ...
    "CUSTOMER_SIGN", "GREENPEAT_SIGN", "CANCEL_CONTRACT", "ACTIVATE_CONTRACT",
    "LOGISTICS_CHECK", "TAX_DOCS", "ACCOUNTING_CHECK", "COMPLETE_CONTRACT"
  ],
  SALES: [
...
export function canRolePerformContractAction(
  ...
  switch (action) {
    ...
    case "TAX_DOCS":
      return status === CONTRACT_STATUSES.SHIPPING_LOGISTICS;
    case "ACCOUNTING_CHECK":
      return status === CONTRACT_STATUSES.TAX_SETTLEMENT;
    case "COMPLETE_CONTRACT":
      return status === CONTRACT_STATUSES.ACCOUNTING_FINAL;
    default:
      return true;
  }
}
