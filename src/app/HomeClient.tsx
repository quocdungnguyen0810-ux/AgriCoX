...
export default function HomeClient({ featuredProducts }: HomeClientProps) {
  ...
  const stats = [
    { value: "5,000+", unit: t.home.statCapacity, label: t.home.statCapacityLabel },
    { value: "15+", unit: t.home.statCountries, label: t.home.statCountriesLabel },
    { value: "200+", unit: t.home.statPartners, label: t.home.statPartnersLabel },
    { value: "6+", unit: t.home.statYears, label: t.home.statYearsLabel },
  ];

  const strengths = [
    { icon: "Leaf", title: t.home.whyRaw, description: t.home.whyRawDesc },
    { icon: "Shield", title: t.home.whyProcess, description: t.home.whyProcessDesc },
    { icon: "Factory", title: t.home.whyFactory, description: t.home.whyFactoryDesc },
  ];
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 text-center">
                      ...
                      <div className="flex justify-center gap-3">
                        {[
                          ...
                          { label: locale === "en" ? "Moisture" : "Ẩm", value: "< 20%" },
                        ].map((spec) => (
                          <div
                            key={spec.label}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="reveal">
              <h2 className="section-title !text-left">
                {locale === "en" ? "Production Process" : "Quy trình sản xuất"}{" "}
                <span className="gradient-text">{locale === "en" ? "Certified" : "đạt chuẩn"}</span>
              </h2>
              ...
              <Link href="/cong-nghe" className="btn-primary">
                {locale === "en" ? "Learn about technology" : "Tìm hiểu công nghệ"} <ArrowRight size={18} />
              </Link>
            </div>
        ...
        <div className="container-custom relative z-10">
          <div className="text-center mb-12">
            <h2 className="section-title reveal !text-white">
              {locale === "en" ? "What our clients say" : "Khách hàng nói gì về chúng tôi"}
            </h2>
          </div>
